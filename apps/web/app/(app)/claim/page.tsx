        ...
        {connected && !loading && streams.length === 0 && (
          <div style={{ background: T.bg1, border: `1px solid ${T.border}`, borderRadius: 20, padding: '48px 32px', textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link href="/new" style={{ padding: '10px 22px', borderRadius: 10, background: T.grad, color: T.text, fontWeight: 700, fontSize: 12, textDecoration: 'none' }}>
                {tx.createStream}
              </Link>
