...
├─────────────────────┬────────┬───────────────┤
│ Field               │ Bytes  │ Deskripsi     │
├─────────────────────┼────────┼───────────────┤
│ discriminator       │   8    │ Anchor tag    │
│ creator             │  32    │ Pubkey creator│
│ recipient           │  32    │ Pubkey penerima│
│ mint                │  32    │ SPL mint      │
│ escrow_token_account│  32    │ Vault PDA     │
│ total_amount        │   8    │ u64 raw token │
│ amount_withdrawn    │   8    │ u64 kumulatif │
│ start_time          │   8    │ i64 unix detik│
│ end_time            │   8    │ i64 unix detik│
│ cliff_time          │   8    │ i64 (0=none)  │
│ is_cancelled        │   1    │ bool          │
│ bump                │   1    │ PDA bump      │
│ seed                │   8    │ u64 creator   │
│ milestone_reached   │   1    │ bool gate     │
│ milestone_enabled   │   1    │ bool config   │
└─────────────────────┴────────┴───────────────┘
```
