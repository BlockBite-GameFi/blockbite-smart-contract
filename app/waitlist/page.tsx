...
const I18N = {
  en: {
    ...
    features: [
      ...
      { color: PURPLE,  t: 'Smart Contract Enforced', d: 'Distribution logic is enforced on-chain. Upgrade authority will be transferred to a 3-of-5 multisig before mainnet. No single key can alter vesting schedules.' },
  ...
  id: {
    ...
    features: [
      ...
      { color: PURPLE,  t: 'Smart Contract Terverifikasi', d: 'Logika distribusi ditegakkan on-chain. Upgrade authority akan dipindahkan ke multisig 3-of-5 sebelum mainnet. Tidak ada kunci tunggal yang bisa mengubah jadwal vesting.' },
